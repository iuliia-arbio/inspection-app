/**
 * Inline SVG icons for the inspection app.
 * Feather-style: 24×24 viewBox, 2px stroke, round caps/joins, no fill.
 * Usage: <CameraIcon className="h-4 w-4" />
 */
...
function Icon({ children, className, ...props }: IconProps) {
  return (
    <svg {...defaults} className={className ?? 'h-4 w-4'} {...props}>
      {children}
    </svg>
  );
}
